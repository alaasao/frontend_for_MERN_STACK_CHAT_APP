...
console.log(data)
  ...
  return (
    <form onSubmit={submit} className="absolute z-10 flex items-center justify-center w-full h-full bg-[#d1d5db91]  transition-all  origin-top duration-2000 ">
      <div className="w-[500px] h-[350px] bg-white flex flex-col rounded-lg py-[50px] px-[20px]">
        ...
        <div className="flex flex-col w-full gap-1 ">
          <label htmlFor="profile_pic" className="mt-[10px] cursor-pointer">
            ...
            <div className="flex items-center gap-[5px]  my-[10px]">
              <Avatar url={uploadPhoto.url} width={"40px"} id={data._id} />
        ...
        <div className="flex items-center justify-end gap-[8px] mt-[10px] cursor-pointer">
          <div
            className="flex justify-center items-center border border-[#008DA5] text-[#008DA5] rounded-lg h-[40px] w-[80px]  "
            onClick={() => {
              setShowUpdate((prev) => !prev);
            }}
          >
